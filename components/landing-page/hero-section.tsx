...
const LiveBadge = () => {
  return <Badge
    variant="outline" className="px-4 py-2 mb-8 text-sm backdrop-blur-sm"
  >
      ...
      <div className="wrapper">
        <div className="flex flex-col items-center justify-center lg:py-24 py-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            <Link href="/submit"><Button size="lg" className="text-base px-8 shadow-lg "><SparklesIcon className="size-5" /> Share Your Project</Button></Link>
            <Link href="/submit"><Button size="lg" variant="secondary" className="text-base px-8 shadow-lg ">Explore Projects <ArrowRightIcon className="size-5" /> </Button></Link>
